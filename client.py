...
def movePlayer1(steps):
    ...
    if (boxPosition):
        ...
        totalSteps = 10
        remSteps = totalSteps-coloredBoxIndex
...
def finishingBox():
    ...
    finishingBox.place(x=screen_width/4 - 380, y=screen_height/2 - 429)
...
def gameWindow():
    ...
    # Display image
    canvas2.create_image( -200, -200, image = bg, anchor = "nw")
...
def askPlayerName():
    ...
    # Display image
    canvas1.create_image( -200, -200, image = bg, anchor = "nw")
...
def recivedMsg():
    ...
    while True:
        ...
        if(player1Name!="joining" and canvas2):
            canvas2.itemconfigure(player1Label, text=player1Label)

        if(player2Name!="joining" and canvas2):
            canvas2.itemconfigure(player2Label, text=player2Label)
